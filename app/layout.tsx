...
export const metadata: Metadata = {
    ...
    other: {
        ...
        'DC.title': 'Estética MCMA - Centro de Estetica',
        ...
        'DC.description': 'Centro de Estetica Profesional en Villa Ballester, Buenos Aires. Especialistas en tratamientos faciales, corporales, medicina estética y cirugías plásticas. Más de 5 años de experiencia.',
